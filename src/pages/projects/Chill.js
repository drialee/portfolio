  ...
  return (
    <div>
      ...
      <div className="project-page">
        ...
        <div className="section" id="Insights" style={{ marginTop: "10vh" }}>
          <h2>Insights</h2>
          ...
          <p>
            How can we{" "}
            <span style={{ color: "#3986FF" }}>simplify the process</span> of
            inviting friends and synchronizing playback across devices for a
            seamless social streaming experience?
          </p>
          <p>
            How might we enable users to transition from individual to group
            streaming experience, {""}
            <span style={{ color: "#3986FF" }}>
          ...
          <div className="col" style={{ gap: "10vh", marginTop: "10vh" }}>
            <div className="row" style={{ gap: "5vw", alignItems: "center" }}>
              ...
              >
                <h4>Home Page</h4>
                <p>
                  Friend interactions are prioritized but parties are now
                  private. Users can view active friend activity in the right
                  side bar and see friend recommendations highlighted at the top
                  of their screen.
                </p>
              </div>
            </div>
            <div className="row" style={{ gap: "5vw", alignItems: "center" }}>
              ...
              >
                <h4>Profile Page</h4>
                <p>
                  Users can select their favorite shows to appear on their
                  profile. When viewing a friend's profile page, they can see
                  their favorites as well as recommendations on compatible shows
                  to watch.
                </p>
              </div>
            </div>
            <div className="row" style={{ gap: "5vw", alignItems: "center" }}>
              ...
              >
                <h4>Video Page</h4>
                <p>
                  When starting a video, users can invite up to 5 active friends
                  to start a watching party.
                </p>
              </div>
            </div>
            <div className="col" style={{ gap: "5vh", alignItems: "center" }}>
              ...
              <p>
                Users can chat live as they enjoy their film together. The right
                section of the streaming screen is allocated to a chat tab and a
                video tab.
              </p>
            </div>
          </div>
